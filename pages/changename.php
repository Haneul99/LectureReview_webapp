...
<div class="wrapper_2">
  <div id="reading">
    <div class="membership">
        <fieldset>
          <legend> <font size="5">사용자 이름 변경</font></legend>
         <br>
         ...
         <form action="changenamefunction.php" method="post">
         	...
         	현재 이름 : <input id="user_name" name="user_name" type="text" value=<?php echo "$username"?> readonly/>
         	변경할 이름 : 
         	<input id="newusername" name="newusername" type="text" value=""/>
