...
<div class="wrapper_2">
  ...
  <h2>리뷰 작성-TOEFL</h2>
      <div id="respond">
        <form action="review_write_TOEFL.php" method="post">
          <br>
          <br>
          <p><label for="title">리뷰 제목 &nbsp;
          <input type="text" name="title" id="title" value="" size="90" />
          </label></p>
          ...
          echo "<p> <label for=\"lecture_info\"> 강의명&nbsp;
          <input type=\"text\" name=\"lecture_name\" id=\"lecture_name\" value=\"$LectureName\" size=\"22\" readonly/>&nbsp;&nbsp;
          강사&nbsp;
          <input type=\"text\" name=\"teacher\" id=\"teacher\" value=\"$Teacher\" size=\"22\" readonly/>  &nbsp;&nbsp;"
          ?>

         점수 (0.0~5.0)&nbsp;
          <input type="text"   name="score" id="score" value="" size="22" />
          </label>
          </p>
          <p>
          ...
          <p>
            <input class="button-small" name="submit" type="submit" id="submit" value="등록" />
            &nbsp; &nbsp;
